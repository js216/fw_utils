...
static int test_field_max_width(void) {
  static const struct reg_field fields[] = {{"max64", 0, 0, 64, 0},
                                            {NULL, 0, 0, 0, 0}};
...
static int test_zero_width_field(void) {
  static const struct reg_field fields[] = {{"zero", 0, 0, 0, 0},
                                            {NULL, 0, 0, 0, 0}};
  uint32_t data[1] = {0};
  struct reg_dev dev = {.reg_width = 32,
                        .reg_num = 1,
...
static int test_field_at_register_end(void) {
  static const struct reg_field fields[] = {{"tail", 0, 24, 8, 0}, // bits 24–31
                                            {NULL, 0, 0, 0, 0}};
  uint32_t data[1] = {0};
  struct reg_dev dev = {.reg_width = 32,
                        .reg_num = 1,
...
static int test_field_highest_bit(void) {
  static const struct reg_field fields[] = {{"msb", 0, 31, 1, 0}, // just bit 31
                                            {NULL, 0, 0, 0, 0}};
  uint32_t data[1] = {0};
  struct reg_dev dev = {.reg_width = 32,
                        .reg_num = 1,
...
static int test_set_no_change(void) {
  static const struct reg_field fields[] = {{"fixed", 0, 0, 16, 0},
                                            {NULL, 0, 0, 0, 0}};
...
static int test_field_starts_late(void) {
  static const struct reg_field fields[] = {{"late", 2, 0, 32, 0},
                                            {NULL, 0, 0, 0, 0}};
  uint32_t data[4] = {0};
  struct reg_dev dev = {.reg_width = 32,
                        .reg_num = 4,
...
static int test_field_ends_early(void) {
  static const struct reg_field fields[] = {{"early", 0, 0, 32, 0},
                                            {NULL, 0, 0, 0, 0}};
  uint32_t data[3] = {0};
  struct reg_dev dev = {.reg_width = 32,
...
static int test_field_with_gap_registers(void) {
  static const struct reg_field fields[] = {
      {"first", 0, 0, 32, 0}, {"second", 2, 0, 32, 0}, {NULL, 0, 0, 0, 0}};
  uint32_t data[3] = {0};
  struct reg_dev dev = {.reg_width = 32,
                        .reg_num = 3,
                        .field_map = fields,
...
static int test_maxfield_unaligned_start(void) {
  static const struct reg_field fields[] = {{"maxfield", 0, 0, 64, 0},
                                            {NULL, 0, 0, 0, 0}};
  uint32_t data[3] = {0};
  struct reg_dev dev = {.reg_width = 32,
                        .reg_num = 3,
...
static int test_reg_set_invalid(void) {
  static const struct reg_field fields[] = {{"bit1", 0, 0, 1, 0},
                                            {"bit4", 0, 0, 4, 0},
                                            {"bit64", 0, 0, 64, 0},
                                            {NULL, 0, 0, 0, 0}};
  ...
  struct {
    const char *name;
    uint64_t val;
  } bad_vals[] = {{"bit1", 2ULL},    // exceeds 1-bit max (1)
