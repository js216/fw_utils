...
static const struct test_cases tc_good[] = {
    ...
    {"B", 0xff,   {0xff, 0xff, 0, 0xff, 0, 0},      {0xffff, 0x0000, 0, 0}, 0},
    {"B", 0xff,   {0xff, 0xff, 0, 0xff, 0, 0},      {0xffff, 0x0000, 0, 0}, 0},
    {"A", 0x00,   {0, 0xff, 0, 0xff, 0, 0},         {0xff00, 0x0000, 0, 0}, 0},
    {"C", 0xffff, {0, 0xff, 0xffff, 0xff, 0, 0},    {0xff00, 0xffff, 0, 0}, 0},
    {"C", 0x98,   {0, 0xff, 0x98, 0xff, 0, 0},      {0xff00, 0x0098, 0, 0}, 0},
    {"P", 0xff,   {0, 0xff, 0x98, 0xff, 0, 0},      {0x00ff, 0x0000, 0, 0}, 1},
